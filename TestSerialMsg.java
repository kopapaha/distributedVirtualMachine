...
public class TestSerialMsg extends net.tinyos.message.Message {
    ...
    public static final int DEFAULT_MESSAGE_SIZE = 252;

    /** The Active Message type associated with this message. */
    public static final int AM_TYPE = 137;

    /** Create a new TestSerialMsg of size 252. */
    ...
    public String toString() {
      ...
      try {
        s += "  [typeMsg=0x"+Long.toHexString(get_typeMsg())+"]\n";
    ...
    /////////////////////////////////////////////////////////
    // Accessor methods for field: typeMsg
    ...
    /**
     * Return whether the field 'typeMsg' is signed (false).
     */
    public static boolean isSigned_typeMsg() {
        return false;
    }

    /**
     * Return whether the field 'typeMsg' is an array (false).
     */
    public static boolean isArray_typeMsg() {
        return false;
    }

    /**
     * Return the offset (in bytes) of the field 'typeMsg'
     */
    public static int offset_typeMsg() {
        return (0 / 8);
    }

    /**
     * Return the offset (in bits) of the field 'typeMsg'
     */
    public static int offsetBits_typeMsg() {
        return 0;
    }

    /**
     * Return the value (as a short) of the field 'typeMsg'
     */
    public short get_typeMsg() {
        return (short)getUIntBEElement(offsetBits_typeMsg(), 8);
    }

    /**
     * Set the value of the field 'typeMsg'
     */
    public void set_typeMsg(short value) {
        setUIntBEElement(offsetBits_typeMsg(), 8, value);
    }

    /**
     * Return the size, in bytes, of the field 'typeMsg'
     */
    public static int size_typeMsg() {
        return (8 / 8);
    }

    /**
     * Return the size, in bits, of the field 'typeMsg'
     */
    public static int sizeBits_typeMsg() {
        return 8;
    }
    ...
    /**
     * Return the value (as a short) of the field 'appId'
     */
    public short get_appId() {
        return (short)getUIntBEElement(offsetBits_appId(), 8);
    }

    /**
     * Set the value of the field 'appId'
     */
    public void set_appId(short value) {
        setUIntBEElement(offsetBits_appId(), 8, value);
    }
    ...
    public static int offset_data(int index1) {
        int offset = 16;
        if (index1 < 0 || index1 >= 250) throw new ArrayIndexOutOfBoundsException();
        offset += 0 + index1 * 8;
        return (offset / 8);
    }
    ...
    public String getString_data() { 
         char carr[] = new char[Math.min(net.tinyos.message.Message.MAX_CONVERTED_STRING_LENGTH,250)];
         int i;
